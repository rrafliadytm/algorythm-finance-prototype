    ...
    <div className="relative flex h-full flex-col overflow-hidden bg-background/95">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {coins.map((c, i) => (
          ...
          >
            <Coins style={{ width: c.size, height: c.size }} className="text-warning" />
          </div>
        ))}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
          ...
          <h1 className="mt-7 text-3xl font-black tracking-tight text-glow-green">MISSION</h1>
          <h1 className="text-3xl font-black tracking-tight text-glow-green">ACCOMPLISHED!</h1>
          ...
          <div className="mt-6 flex items-center gap-3">
            <div className="flex items-center gap-2 rounded-2xl border border-warning/30 bg-warning/10 px-4 py-3">
              ...
              <span className="text-[11px] font-medium text-muted-foreground">Gold</span>
            </div>
            <div className="flex items-center gap-2 rounded-2xl border border-primary/30 bg-primary/10 px-4 py-3">
              ...
              <span className="text-[11px] font-medium text-muted-foreground">XP</span>
            </div>
          </div>
        </div>
